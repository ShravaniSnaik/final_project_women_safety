...
//               initialCenter:
//                   _currentLocation ??
//                   LatLng(22.3397, 87.3250), // Default: New Delhi
//               initialZoom: _currentZoom,
//               interactionOptions: const InteractionOptions(
...
class _DangerMapPageState extends State<DangerMapPage> {
  ...
  // Danger zones remain persistent
  final List<CircleMarker> _dangerZones = [
    CircleMarker(
      point: LatLng(22.3149, 87.3105), // IIT Kharagpur
      color: Colors.red.withOpacity(0.7),
      radius: 2500,
      useRadiusInMeter: true,
    ),
    CircleMarker(
      point: LatLng(21.900526, 87.538078), // Kolkata
      color: Colors.red.withOpacity(0.7),
      radius: 2500,
      useRadiusInMeter: true,
    ),
      ...
      body: Stack(
        children: [
          FlutterMap(
            mapController: _mapController,
            options: MapOptions(
              initialCenter: _currentLocation ?? LatLng(22.3149, 87.3105),
              initialZoom: _currentZoom,
              interactionOptions: const InteractionOptions(
                flags: InteractiveFlag.all,
              ),
            ...
            children: [
              ...
              // Danger zones are static and always remain
              CircleLayer(circles: _dangerZones),
            ],
          ),
