List womenEmpowermentQuotes = [
  ...
  "Do what you love, and you’ll never fail.",
  "A strong woman stands up for herself.",
  "Dream big, work hard, stay focused.",
  "You are your only limit—break it.",
  "Confidence is power—embrace it.",
  "Rise, shine, and own your power.",
  "Fearless women shape the future.",
];
